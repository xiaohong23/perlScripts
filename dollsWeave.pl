...
print OUTPUT "\n";
print OUTPUT 'print  "var picDir = \"http://xiaohong.t15.org/imagevue/content/'; 
print OUTPUT "$folder";
print OUTPUT '/$folder\";\n";'; 
print OUTPUT "\n";
...
print OUTPUT "next; \n";
print OUTPUT "} \n";
print OUTPUT "elsif (\$file=~ /tn_/i) { \n";
print OUTPUT "next; \n";
print OUTPUT "} \n";
print OUTPUT "elsif (\$file=~ /folderdata.xml/i) { \n";
print OUTPUT "next; \n";
print OUTPUT "} \n";
print OUTPUT "else { \n";
